...
export default function SubtitlesPage() {
  return (
    <div className="space-y-6">
      {/* Header */}
      <div>
        <h1 className="text-3xl font-bold text-green-800">Channel subtitles</h1>
      </div>
      ...
      {/* Table Headers */}
      <div className="grid grid-cols-3 gap-4 text-sm text-green-600 border-b border-green-200 pb-2">
        <div>Video</div>
      ...
      <div className="flex flex-col items-center justify-center py-16 space-y-6">
        ...
        <div className="text-center space-y-2">
          <p className="text-xl text-green-600">No subtitles available</p>
          <p className="text-sm text-green-500">Upload videos to get started with subtitles</p>
        </div>
